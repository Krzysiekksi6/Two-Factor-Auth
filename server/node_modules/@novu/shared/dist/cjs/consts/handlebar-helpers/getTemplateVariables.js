...
function getTemplateVariables(bod) {
    const stringVariables = bod
        ...
        return {
            type: message_template_1.TemplateVariableTypeEnum.STRING,
    ...
    const arrayVariables = bod
        ...
        return [
            {
                type: message_template_1.TemplateVariableTypeEnum.ARRAY,
                name: varName,
                required: false,
            },
    ...
    const boolVariables = bod
        ...
        return [
            {
                type: message_template_1.TemplateVariableTypeEnum.BOOLEAN,
                name: varName,
                defaultValue: true,
                required: false,
            },
